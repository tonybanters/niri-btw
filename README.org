...
- Per Monitor Workspaces (Shoutout to The Linux Cast because I know he loves that so much, and he loves xwayland-satellite.)
- and much more.
...
- [[#load-niri][Load Niri]]
- [[#noctalia-shell--autostart][Noctalia Shell + Autostart]]
- [[#wallpaper][Wallpaper]]
...
#+begin_src sh
sudo pacman -Sy alacritty fuzzel swaybg firefox ttf-jetbrains-mono-nerd xwayland-satellite
#+end_src
